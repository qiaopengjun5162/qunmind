...
用户明确提供且已经补齐日期、可读原文和可靠中文摘要的 `manual_items`，应优先于普通聚合快讯成为焦点；这是人工编辑判断的显式输入，不应再被“非快讯优先”规则误降级。焦点已经承载的 URL 不应再重复进入正文，哪怕它是该板块唯一候选。反过来，没有可靠中文摘要或可读中文标题的英文快讯不能为了凑满 Web3 正文硬写成泛化中文，应移入补充阅读池；当天可信候选不足时允许正文板块少于三条。
