...
- `cargo nextest run --all-features`：139 tests passing, 1 ignored PostgreSQL integration test compiled and skipped by default.
- `cargo llvm-cov nextest --all-features --summary-only`：87.91% line coverage, 139 tests passing.
