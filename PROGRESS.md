...
- `cargo nextest run --all-features`：131 tests passing, 1 ignored PostgreSQL integration test compiled and skipped by default.
- `cargo llvm-cov nextest --all-features --summary-only`：86.74% line coverage, 131 tests passing.
