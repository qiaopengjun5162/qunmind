...
JSON schema（严格按此输出）：
{{
  "title_hint": "6-16字的中文标题，客观概括今日技术动态，不夸张不渲染，例如：'Rust项目领跑GitHub，AI论文聚焦多Agent'",
  "intro": "1-2句客观陈述，说明今天什么方向比较活跃、出现了哪些值得关注的新项目或论文，不做判断",
  "focus_text": "今日最重要的一条新闻是什么，用一句话说清楚，不加评论",
  "focus_url": "对应URL",
  "ai_items": [
    {{
  ...
  "reads": [
    {{
      "title": "文章标题",
      "url": "原始URL（必填，必须来自新闻列表）",
      "summary": "必填！2-3句话（不少于20字），客观概括文章核心论点，不加入自己的看法，禁止留空"
    }}
  ],
...
- web3_items 只写有真实 URL 的条目。如果新闻列表中 Web3 相关内容不足 3 条，有几条写几条，绝对不允许 url 为空或编造链接。
