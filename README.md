...
- Public-account daily reports use a deterministic recipe by default: Rust handles source ranking, deduplication, sections, focus, deep reads, source index, fixed outro, and lint without a per-issue model call. AI remains for ordinary group-chat summaries or a future explicit deep-rewrite mode.
